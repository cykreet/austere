...
| [Advancement Plaques](https://modrinth.com/mod/advancement-plaques) | Grend | Replace those boring advancement popups with something flashier. |
...
| [Camps. Castles. Carriages.](https://modrinth.com/mod/camps_castles_carriages) | Eugene | Add more medieval-fairy-tale style structures to your vanilla world! |
...
| [Enderman Overhaul](https://modrinth.com/mod/enderman-overhaul) | Joo5h | Enderman Overhaul adds over 20 new enderman variants, each with their own sounds, models, and animations! |
...
| [Expanded Delight](https://modrinth.com/mod/expanded-delight) | ianm1647 | An addon mod for Farmer's Delight Fabric that adds many more crops and functionality to the base mod |
...
| [[Deprecated] Farmer's Delight [Fabric]](https://modrinth.com/mod/farmers-delight-fabric) | Zifiv | Farmer's Delight is a mod that gently expands upon farming and cooking in Minecraft. |
...
| [Iris Shaders](https://modrinth.com/mod/iris) | coderbot | A modern shaders mod for Minecraft intended to be compatible with existing OptiFine shader packs |
...
| [Smooth Gui](https://modrinth.com/mod/smooth-gui) | Ezzenix | Smooth animation when opening GUI for Minecraft.<br>GUI fades up when opened. |
...
| [Spell Engine](https://modrinth.com/mod/spell-engine) | ZsoltMolnarrr | 🪄 Data driven magic library |
...
| [Vanilla Refresh](https://modrinth.com/mod/vanilla-refresh) | limesplatus | A variety of 30+ QOL features like player sitting and a day counter, all configurable within a settings menu. |
...
| [Wizards (RPG Series)](https://modrinth.com/mod/wizards) | ZsoltMolnarrr | 🧙🏻‍♂️ Destroy your enemies with Arcane, Fire and Frost magic |
...
| [YetAnotherConfigLib](https://modrinth.com/mod/yacl) | isxander | A builder-based configuration library for Minecraft. |
| [YDM's MobHealthBar](https://modrinth.com/mod/ydms-mobhealthbar) | YourDailyModder | Health Bar above mobs |
